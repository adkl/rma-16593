...
/**
 * Created by Adnan on 06-May-16.
 */
public class SearchMusician extends AsyncTask<String, Integer, Void> {
    OnSearchMusicianDone caller;
    ArrayList<Musician> musicians = new ArrayList<>();
    public SearchMusician(OnSearchMusicianDone _caller) {
        caller = _caller;
    }
    @Override
    ...
    public interface OnSearchMusicianDone {
        public void onDone(ArrayList<Musician> musicianList);
    }
}
