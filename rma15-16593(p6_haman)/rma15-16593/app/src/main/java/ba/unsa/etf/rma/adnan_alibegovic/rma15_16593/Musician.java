...
public class Musician implements Parcelable, Serializable {
    ...
    public void addAlbum(Pair<String, String> _album) { albums.add(_album);}
    ...
    public List<Musician> getSimilarMusicians() {
        ...
        for (Musician m : musicians) {
            if(m.getGenre().equals(this.genre) && !m.getName().equals(this.name)){
              ...
              // morali smo promijeniti u name, jer sa spotify-a kad vucemo, biography nam ostaje null pa bi uslov padao
