...
public class MainActivity extends AppCompatActivity implements MusiciansListFragment.OnMusicianItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MusicianDBOpenHelper dbOpenHelper = new MusicianDBOpenHelper(this);
        SQLiteDatabase db = dbOpenHelper.getWritableDatabase();

        ContentValues contentValues = new ContentValues();
        contentValues.put(dbOpenHelper.MUSICIAN_NAME, "Zeljko Joksimovic");
        contentValues.put(dbOpenHelper.MUSICIAN_GENRE, "pop");

        db.insertOrThrow(dbOpenHelper.DB_TABLE, null, contentValues);

        contentValues.put(dbOpenHelper.MUSICIAN_NAME, "Joe Cocker");
        contentValues.put(dbOpenHelper.MUSICIAN_GENRE, "rock");

        db.insertOrThrow(dbOpenHelper.DB_TABLE, null, contentValues);

        contentValues.put(dbOpenHelper.MUSICIAN_NAME, "Halid Beslic");
        contentValues.put(dbOpenHelper.MUSICIAN_GENRE, "folk");
...
//        }
    ...
    public void onDestroy() {
        ...
        MusicianDBOpenHelper dbHelper = new MusicianDBOpenHelper(this);
